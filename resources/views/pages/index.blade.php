<?php
define('URLROOT', 'http://localhost/phpconnections_producto_2');
define('SITENAME', 'Student Class Schedule');
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo URLROOT; ?>/students/login">Students</a></li>                        
                        <li class="nav-item"><a class="nav-link" href="<?php echo URLROOT; ?>/admins/login">Admins</a></li>                        
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead">
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                        ...
                        <h1 class="text-white font-weight-bold"><?php echo SITENAME; ?></h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5"> All your classes here </p>
                        <a class="btn btn-primary btn-xl" href="<?php echo URLROOT; ?>/students/login">Join now!</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><img src="assets/icons/outline_auto_fix_high_black_24dp.png"><i class="fs-1 text-primary"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><img src="assets/icons/outline_manage_accounts_black_24dp.png"><i class="fs-1 text-primary"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><img src="assets/icons/outline_admin_panel_settings_black_24dp.png"><i class="fs-1 text-primary"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><img src="assets/icons/outline_lightbulb_black_24dp.png"><i class="fs-1 text-primary"></i></div>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2021 - PHP-Connections</div></div>
        </footer>
        <!-- Bootstrap core JS-->
